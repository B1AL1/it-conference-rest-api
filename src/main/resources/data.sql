...
INSERT INTO LECTURE(id, title, starting, ending, max_amount_of_users, thematic_path) VALUES (1, 'V is for Visibility: The Essential Cybersecurity Ingredient in a VUCA World.', {ts '2021-06-01 10:00:00.00'}, {ts '2021-06-01 11:45:00.00'}, 5, 1);
INSERT INTO LECTURE(id, title, starting, ending, max_amount_of_users, thematic_path) VALUES (2, 'Cybersecurity First Principles.', {ts '2021-06-01 12:00:00.00'}, {ts '2021-06-01 13:45:00.00'}, 5, 1);
INSERT INTO LECTURE(id, title, starting, ending, max_amount_of_users, thematic_path) VALUES (3, 'Human Security Engineering: Stop Relying on the Failed Human Firewall.', {ts '2021-06-01 14:00:00.00'}, {ts '2021-06-01 15:45:00.00'}, 5, 1);
INSERT INTO LECTURE(id, title, starting, ending, max_amount_of_users, thematic_path) VALUES (4, 'Crouching Hacker, Killer Robot? Removing FUD from Cyber-physical Security.', {ts '2021-06-01 10:00:00.00', {ts '2021-06-01 11:45:00.00'}}, 5, 2);
INSERT INTO LECTURE(id, title, starting, ending, max_amount_of_users, thematic_path) VALUES (5, 'Jak rozmawiać o cyberbezpieczeństwie z CEO?', {ts '2021-06-01 12:00:00.00'}, {ts '2021-06-01 13:45:00.00'}, 5, 2);
INSERT INTO LECTURE(id, title, starting, ending, max_amount_of_users, thematic_path) VALUES (6, 'Czy z Twojej strony XS-wyciekają wrażliwe dane?', {ts '2021-06-01 14:00:00.00'}, {ts '2021-06-01 15:45:00.00'}, 5, 2);
INSERT INTO LECTURE(id, title, starting, ending, max_amount_of_users, thematic_path) VALUES (7, 'Jak przestępcy wykorzystują technologię do kradzieży pieniędzy w oszustwie tzw. "fałszywych inwestycji".', {ts '2021-06-01 10:00:00.00'}, {ts '2021-06-01 11:45:00.00'}, 5, 3);
INSERT INTO LECTURE(id, title, starting, ending, max_amount_of_users, thematic_path) VALUES (8, 'Dziś i jutro e-commerce – jakie trendy zyskują na popularności i znaczeniu?', {ts '2021-06-01 12:00:00.00'}, {ts '2021-06-01 13:45:00.00'}, 5, 3);
INSERT INTO LECTURE(id, title, starting, ending, max_amount_of_users, thematic_path) VALUES (9, '2021 rokiem zakupów online, ale czy do sukcesu wciąż wystarczy tylko sam sklep?', {ts '2021-06-01 14:00:00.00'}, {ts '2021-06-01 15:45:00.00'}, 5, 3);
